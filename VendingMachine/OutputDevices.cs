...
namespace VendingMachine
{
    ...
    public class Light  // this actually plays the roles of PurchasableLight, SoldOutLight
    {
        PictureBox pbx;
        Color onColor;
    ...
    public class TimerLight : Light  // This is the no change light
    {
        Timer timer;
    ...
    public class CoinDispenser
    {
        ...
        public void Clear()  // to pick up coins
        {
            txbChange.Text = "";
        }
    }
    ...
    public class CanDispenser
    {
        ...
        public void Clear()  // to pick up can
        {
            this.txbCan.Text = "";
        }
    }
